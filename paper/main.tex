...
(R1-Qwen commit\%\,=\,75.8\%, R1-Llama\,=\,82.9\%, Qwen3\,=\,99.8\%; C049 threshold-invariant).
Truncating generation at the commit point costs $+$0.012~F1 at 90\% token
savings---established causally, not observationally (EXP-I, $N$\,=\,500, $t$\,=\,6.0,
$p$\,$<$\,0.0001; C028 \textsc{confirmed}). The confabulation probe also transfers to
commit-point hidden states (EXP-F; AUROC\,=\,0.6500).
